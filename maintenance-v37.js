(()=>{
  ...
  const LOGO = '/CS2/creative-squad/logo-cdl.svg';
  ...
  function brandImages(){
    document.querySelectorAll('img').forEach(img=>{
      ...
      if(alt.includes('cdl') || alt.includes('creative dark legends') || src.includes('logo-cdl') || src.includes('logo_cs') || src.endsWith('/logo.jpg')){
        img.src=LOGO+'?v=37';
      }
    });
  }
  ...
  function boot(){
    ...
    style.textContent=`
      ...
      #cdlMaintenance img{width:132px;height:132px;object-fit:contain;filter:drop-shadow(0 0 18px #76ff3540)}
    ...
    screen.innerHTML=`<div class="box"><img src="${LOGO}?v=37" alt="CDL"><div class="tool">🔧</div><h1>Site em manutenção</h1><p>Estamos fazendo ajustes no Creative Dark Legends 2 • COPA CDL.</p><div class="return">Voltamos às 06:00</div><div id="cdlCountdown">--:--:--</div><div class="date">23/09/2026 às 06:00 • horário de Brasília</div></div>`;
